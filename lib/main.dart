...
import 'package:demo_application/models/forecast.dart';
  ...
  Widget build(BuildContext context) {
                    ...
                    child: Column(
                      ...
                      children: [
                            ...
                            if (snapshot.hasData) {
                              ...
                              return SizedBox(
                                ...
                                child: ListView.builder(
                                  ...
                                  //  print("$hourlyData.list![index].main!.temp}$degree");
                        ...
                        Row(
                          mainAxisAlignment: MainAxisAlignment.spaceBetween,
                          children: [
                            "Next 10 Days".text.semiBold.size(16).color(theme.primaryColor).make(),
                            TextButton(onPressed: () {}, child: "View All".text.make()),
                          ],
                        ),
                    FutureBuilder(
                   future: controller.forecast,
                 builder: (BuildContext context, AsyncSnapshot snapshot) {
                if (snapshot.hasData) {
    ...
    child:  ListView.builder(
      ...
      itemBuilder: (BuildContext context, int index) {
        ...
        var date1 = DateFormat("yMMMMd").format(DateTime.now().add(Duration(days: index + 1)));
       // var time = DateFormat.yMMMMd().format(DateTime.fromMillisecondsSinceEpoch(forecast.list ![index].dt!.toInt() * 1000));

        print("${forecast.list![index].main!.temp}$degree");
        ...
        return Card(
          child: Container(
            ...
            child: Row(
              mainAxisAlignment: MainAxisAlignment.spaceBetween,
              children: [
                Expanded(child: date1.text.semiBold.color(theme.primaryColor).make()),
                Expanded(
                  child: TextButton.icon(
                      onPressed: null,
                      icon: Image.asset( "assets/weather/${forecast.list![index].weather![0].icon}.png", width: 40),
                      label: "${ forecast.list![index].main!.temp}$degree".text.size(16).color(theme.primaryColor).make()),
                ...
                RichText(
                  text: TextSpan(
                    children: [
                      TextSpan(
                          text: "${ forecast.list![index].main!.tempMax}$degree",
                          style: TextStyle(
                            color: theme.primaryColor,
                            fontFamily: "poppins",
                            fontSize: 16,
                      ...
                      TextSpan(
                          text: " ${ forecast.list![index].main!.tempMin}$degree",
                          style: TextStyle(
